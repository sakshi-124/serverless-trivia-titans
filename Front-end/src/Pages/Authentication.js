    ...
    >
      <div className="page-card">
        <p className="registration-header">
          {isAlreadyUser ? "Login" : "Registration"}
        </p>
        <div className="registration-form-body">
          ...
          {isAlreadyUser ? null : (
            <>
              ...
              <p
                className="registration-error-message"
                style={{ display: isConfirmPasswordValid ? "none" : "block" }}
              >
          ...
          <p className="auth-alt-message">
            {isAlreadyUser ? "Don't have Account?" : "Have account already?"}{" "}
            <span
              className="auth-link"
              onClick={() => setIsAlreadyUser(!isAlreadyUser)}
            >
              {isAlreadyUser ? "Register" : "Login"}
            </span>
          </p>
